...
// ES module mirror of the 300 active combat skills catalog across the 6 playable classes.
...
export const SKILLS = [
  ...
  // =========================================================================
  {
    ...
    costType: 'stamina', cost: 15, cooldown: 4, range: 80, icon: '🔨', iconColor: '#e11d48',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 12, cooldown: 5, range: 90, icon: '🗡️', iconColor: '#be123c',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 18, cooldown: 8, range: 70, icon: '🛡️', iconColor: '#fbbf24',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 7, range: 80, icon: '💀', iconColor: '#e2e8f0',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 16, cooldown: 5, range: 100, icon: '🩸', iconColor: '#dc2626',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 14, cooldown: 4, range: 110, icon: '🗡️', iconColor: '#94a3b8',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 10, cooldown: 3, range: 80, icon: '⚡', iconColor: '#f59e0b',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 14, cooldown: 3, range: 80, icon: '⚔️', iconColor: '#cbd5e1',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 22, cooldown: 9, range: 140, icon: '🌋', iconColor: '#d97706',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 30, cooldown: 12, range: 80, icon: '🪓', iconColor: '#991b1b',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 18, cooldown: 14, range: 70, icon: '✋', iconColor: '#a855f7',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 10, cooldown: 8, range: 60, icon: '👊', iconColor: '#64748b',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 7, range: 100, icon: '🔄', iconColor: '#f97316',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 22, cooldown: 6, range: 90, icon: '💥', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 24, cooldown: 8, range: 120, icon: '🌊', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 15, range: 80, icon: '🔥', iconColor: '#ea580c',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 35, cooldown: 18, range: 100, icon: '⚡', iconColor: '#facc15',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 26, cooldown: 12, range: 90, icon: '🩸', iconColor: '#b91c1c',
  ...
  // Warrior Magic & Powers
  {
    ...
    costType: 'mana', cost: 20, cooldown: 8, range: 240, icon: '💨', iconColor: '#94a3b8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 12, range: 280, icon: '🪨', iconColor: '#78716c',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 10, range: 120, icon: '💥', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'mana', cost: 28, cooldown: 9, range: 100, icon: '⚡', iconColor: '#eab308',
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 25, range: 100, icon: '🛡️', iconColor: '#a8a29e',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 30, cooldown: 10, range: 360, icon: '☄️', iconColor: '#f59e0b',
  ...
  },
  {
    ...
    costType: 'mana', cost: 18, cooldown: 5, range: 320, icon: '🍃', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 24, cooldown: 8, range: 90, icon: '❄️', iconColor: '#67e8f9',
  ...
  },
  {
    ...
    costType: 'mana', cost: 50, cooldown: 60, range: 200, icon: '👑', iconColor: '#fbbf24',
  ...
  // Warrior Buffs
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 30, range: 240, icon: '🗣️', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 35, cooldown: 60, range: 200, icon: '🚩', iconColor: '#e11d48',
  ...
  // Warrior Debuffs
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 20, range: 200, icon: '🦁', iconColor: '#b45309',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 15, cooldown: 5, range: 90, icon: '🔨', iconColor: '#ea580c',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 16, cooldown: 12, range: 90, icon: '🩸', iconColor: '#be123c',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 10, cooldown: 15, range: 240, icon: '🤬', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 14, cooldown: 10, range: 80, icon: '👁️', iconColor: '#991b1b',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 18, cooldown: 18, range: 160, icon: '😨', iconColor: '#7c3aed',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 18, cooldown: 12, range: 90, icon: '🦴', iconColor: '#cbd5e1',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 15, cooldown: 25, range: 120, icon: '👀', iconColor: '#475569',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 16, cooldown: 14, range: 90, icon: '💉', iconColor: '#881337',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 15, cooldown: 10, range: 90, icon: '🩼', iconColor: '#b45309',
  ...
  // =========================================================================
  {
    ...
    costType: 'mana', cost: 12, cooldown: 1, range: 80, icon: '🗡️', iconColor: '#c084fc',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 6, range: 70, icon: '🔥', iconColor: '#f97316',
  ...
  },
  {
    ...
    costType: 'mana', cost: 18, cooldown: 4, range: 100, icon: '❄️', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 5, range: 80, icon: '⚡', iconColor: '#facc15',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 8, range: 120, icon: '💥', iconColor: '#e879f9',
  ...
  },
  {
    ...
    costType: 'mana', cost: 15, cooldown: 3, range: 90, icon: '⚔️', iconColor: '#818cf8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 16, cooldown: 9, range: 90, icon: '🪄', iconColor: '#fbbf24',
  ...
  },
  {
    ...
    costType: 'mana', cost: 0, cooldown: 10, range: 70, icon: '🔮', iconColor: '#a855f7',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 5, range: 110, icon: '💫', iconColor: '#c084fc',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 7, range: 80, icon: '🎭', iconColor: '#a78bfa',
  ...
  // Mage Spells
  {
    ...
    costType: 'mana', cost: 25, cooldown: 2, range: 400, icon: '🔥', iconColor: '#ea580c',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 1.5, range: 440, icon: '❄️', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 6, range: 360, icon: '⚡', iconColor: '#eab308',
  ...
  },
  {
    ...
    costType: 'mana', cost: 60, cooldown: 30, range: 480, icon: '☄️', iconColor: '#dc2626',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 12, range: 200, icon: '❄️', iconColor: '#0284c7',
  ...
  },
  {
    ...
    costType: 'mana', cost: 40, cooldown: 8, range: 360, icon: '⚡', iconColor: '#facc15',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 8, range: 320, icon: '✨', iconColor: '#c084fc',
  ...
  },
  {
    ...
    costType: 'mana', cost: 45, cooldown: 18, range: 300, icon: '🔥', iconColor: '#f97316',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 3, range: 400, icon: '✨', iconColor: '#d8b4fe',
  ...
  },
  {
    ...
    costType: 'mana', cost: 50, cooldown: 30, range: 400, icon: '🕳️', iconColor: '#6b21a8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 65, cooldown: 40, range: 500, icon: '🌩️', iconColor: '#f59e0b',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 5, range: 360, icon: '🌈', iconColor: '#ec4899',
  ...
  },
  {
    ...
    costType: 'mana', cost: 45, cooldown: 12, range: 360, icon: '⚡', iconColor: '#e11d48',
  ...
  },
  {
    ...
    costType: 'mana', cost: 28, cooldown: 10, range: 240, icon: '💥', iconColor: '#f97316',
  ...
  },
  {
    ...
    costType: 'mana', cost: 50, cooldown: 20, range: 440, icon: '☄️', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 8, range: 280, icon: '⚡', iconColor: '#eab308',
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 25, range: 160, icon: '🔥', iconColor: '#ea580c',
  ...
  },
  {
    ...
    costType: 'mana', cost: 40, cooldown: 60, range: 240, icon: '🧠', iconColor: '#c084fc',
  ...
  // Mage Debuffs
  {
    ...
    costType: 'mana', cost: 20, cooldown: 12, range: 360, icon: '🟣', iconColor: '#a855f7',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 15, range: 320, icon: '🧊', iconColor: '#0284c7',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 10, range: 360, icon: '🔥', iconColor: '#b91c1c',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 20, range: 320, icon: '🤫', iconColor: '#64748b',
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 30, range: 320, icon: '🐑', iconColor: '#f1f5f9',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 8, range: 360, icon: '⚡', iconColor: '#eab308',
  ...
  },
  {
    ...
    costType: 'mana', cost: 40, cooldown: 25, range: 360, icon: '⏱️', iconColor: '#6366f1',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 14, range: 320, icon: '🔥', iconColor: '#9333ea',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 15, range: 240, icon: '☀️', iconColor: '#fde047',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 18, range: 300, icon: '🌀', iconColor: '#c084fc',
  ...
  // =========================================================================
  {
    ...
    costType: 'mana', cost: 8, cooldown: 2, range: 90, icon: '✋', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 15, cooldown: 6, range: 110, icon: '🦶', iconColor: '#f97316',
  ...
  },
  {
    ...
    costType: 'mana', cost: 18, cooldown: 8, range: 80, icon: '🎯', iconColor: '#a855f7',
  ...
  },
  {
    ...
    costType: 'mana', cost: 10, cooldown: 3, range: 80, icon: '🐍', iconColor: '#10b981',
  ...
  },
  {
    ...
    costType: 'mana', cost: 14, cooldown: 4, range: 80, icon: '🐅', iconColor: '#ea580c',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 8, range: 90, icon: '✨', iconColor: '#ec4899',
  ...
  },
  {
    ...
    costType: 'mana', cost: 28, cooldown: 10, range: 320, icon: '☄️', iconColor: '#fbbf24',
  ...
  },
  {
    ...
    costType: 'mana', cost: 12, cooldown: 5, range: 90, icon: '🦗', iconColor: '#84cc16',
  ...
  },
  {
    ...
    costType: 'mana', cost: 16, cooldown: 7, range: 100, icon: '🐉', iconColor: '#f97316',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 6, range: 80, icon: '🛡️', iconColor: '#94a3b8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 8, range: 90, icon: '💥', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'mana', cost: 10, cooldown: 8, range: 90, icon: '🪶', iconColor: '#e2e8f0',
  ...
  },
  {
    ...
    costType: 'mana', cost: 18, cooldown: 6, range: 120, icon: '🌊', iconColor: '#0ea5e9',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 10, range: 80, icon: '🧘', iconColor: '#facc15',
  ...
  },
  {
    ...
    costType: 'mana', cost: 15, cooldown: 12, range: 70, icon: '🔒', iconColor: '#64748b',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 7, range: 90, icon: '👥', iconColor: '#a78bfa',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 14, range: 80, icon: '🧠', iconColor: '#c084fc',
  ...
  },
  {
    ...
    costType: 'mana', cost: 12, cooldown: 4, range: 100, icon: '🌊', iconColor: '#06b6d4',
  ...
  // Monk Magic & Chi
  {
    ...
    costType: 'mana', cost: 25, cooldown: 8, range: 360, icon: '🌊', iconColor: '#10b981',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 10, range: 320, icon: '🔮', iconColor: '#34d399',
  ...
  },
  {
    ...
    costType: 'mana', cost: 24, cooldown: 8, range: 160, icon: '✨', iconColor: '#fbbf24',
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 20, range: 240, icon: '🔔', iconColor: '#f59e0b',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 10, range: 360, icon: '🌫️', iconColor: '#a7f3d0',
  ...
  },
  {
    ...
    costType: 'mana', cost: 28, cooldown: 14, range: 200, icon: '🍃', iconColor: '#16a34a',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 10, range: 240, icon: '🔥', iconColor: '#ea580c',
  ...
  },
  {
    ...
    costType: 'mana', cost: 40, cooldown: 45, range: 400, icon: '👤', iconColor: '#818cf8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 45, cooldown: 25, range: 360, icon: '⚡', iconColor: '#facc15',
  ...
  // Monk Buffs
  {
    ...
    costType: 'mana', cost: 15, cooldown: 20, range: 240, icon: '🧘', iconColor: '#38bdf8',
    descUk: 'Активна техніка дихання: прискорює відновлення мани на 100% на 12 сек.',
    descEn: 'Active breathing meditation: doubles mana regeneration rate for 12s.'
  },
  {
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 20, range: 160, icon: '💖', iconColor: '#ec4899',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 30, range: 240, icon: '🍃', iconColor: '#67e8f9',
  ...
  // Monk Debuffs
  {
    ...
    costType: 'mana', cost: 20, cooldown: 18, range: 120, icon: '🛑', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 20, range: 90, icon: '⚡', iconColor: '#eab308',
  ...
  },
  {
    ...
    costType: 'mana', cost: 18, cooldown: 14, range: 240, icon: '⚖️', iconColor: '#64748b',
  ...
  },
  {
    ...
    costType: 'mana', cost: 16, cooldown: 12, range: 90, icon: '💨', iconColor: '#94a3b8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 15, range: 200, icon: '👁️', iconColor: '#475569',
  ...
  },
  {
    ...
    costType: 'mana', cost: 14, cooldown: 10, range: 80, icon: '💫', iconColor: '#f59e0b',
  ...
  },
  {
    ...
    costType: 'mana', cost: 18, cooldown: 12, range: 100, icon: '💔', iconColor: '#be123c',
  ...
  },
  {
    ...
    costType: 'mana', cost: 12, cooldown: 8, range: 90, icon: '🤼', iconColor: '#d97706',
  ...
  },
  {
    ...
    costType: 'mana', cost: 24, cooldown: 16, range: 120, icon: '🔔', iconColor: '#9333ea',
  ...
  },
  {
    ...
    costType: 'mana', cost: 15, cooldown: 14, range: 100, icon: '🔇', iconColor: '#334155',
  ...
  // =========================================================================
  {
    ...
    costType: 'hp', cost: 15, cooldown: 1, range: 80, icon: '🗡️', iconColor: '#991b1b',
  ...
  },
  {
    ...
    costType: 'hp', cost: 25, cooldown: 5, range: 120, icon: '🩸', iconColor: '#dc2626',
  ...
  },
  {
    ...
    costType: 'hp', cost: 30, cooldown: 8, range: 70, icon: '🫀', iconColor: '#7f1d1d',
  ...
  },
  {
    ...
    costType: 'hp', cost: 20, cooldown: 6, range: 80, icon: '🥩', iconColor: '#b91c1c',
  ...
  },
  {
    ...
    costType: 'hp', cost: 18, cooldown: 4, range: 80, icon: '🩸', iconColor: '#e11d48',
  ...
  },
  {
    ...
    costType: 'hp', cost: 22, cooldown: 5, range: 90, icon: '🦴', iconColor: '#334155',
  ...
  },
  {
    ...
    costType: 'hp', cost: 20, cooldown: 7, range: 100, icon: '⚰️', iconColor: '#451a03',
  ...
  },
  {
    ...
    costType: 'hp', cost: 28, cooldown: 6, range: 110, icon: '⛓️', iconColor: '#881337',
  ...
  },
  {
    ...
    costType: 'hp', cost: 10, cooldown: 10, range: 60, icon: '🧛', iconColor: '#991b1b',
  ...
  },
  {
    ...
    costType: 'hp', cost: 20, cooldown: 8, range: 90, icon: '☣️', iconColor: '#4c1d95',
  ...
  // Cultist Blood & Dark Magic
  {
    ...
    costType: 'hp', cost: 30, cooldown: 2, range: 360, icon: '🔴', iconColor: '#dc2626',
  ...
  },
  {
    ...
    costType: 'hp', cost: 35, cooldown: 4, range: 440, icon: '💉', iconColor: '#b91c1c',
  ...
  },
  {
    ...
    costType: 'hp', cost: 40, cooldown: 12, range: 240, icon: '🩸', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'hp', cost: 15, cooldown: 3, range: 360, icon: '💥', iconColor: '#7f1d1d',
  ...
  },
  {
    ...
    costType: 'hp', cost: 50, cooldown: 30, range: 200, icon: '🌪️', iconColor: '#e2e8f0',
  ...
  },
  {
    ...
    costType: 'hp', cost: 25, cooldown: 10, range: 320, icon: '🖐️', iconColor: '#312e81',
  ...
  },
  {
    ...
    costType: 'hp', cost: 80, cooldown: 60, range: 160, icon: '🗿', iconColor: '#b91c1c',
  ...
  },
  {
    ...
    costType: 'hp', cost: 70, cooldown: 35, range: 440, icon: '🖤', iconColor: '#0f172a',
  ...
  },
  {
    ...
    costType: 'hp', cost: 35, cooldown: 18, range: 320, icon: '⭕', iconColor: '#701a75',
  ...
  },
  {
    ...
    costType: 'hp', cost: 30, cooldown: 3, range: 400, icon: '🦴', iconColor: '#f1f5f9',
  ...
  },
  {
    ...
    costType: 'hp', cost: 0, cooldown: 20, range: 240, icon: '🩸', iconColor: '#be123c',
  ...
  },
  {
    ...
    costType: 'hp', cost: 35, cooldown: 15, range: 300, icon: '☠️', iconColor: '#166534',
  ...
  },
  {
    ...
    costType: 'hp', cost: 60, cooldown: 45, range: 400, icon: '☀️', iconColor: '#1e1b4b',
  ...
  },
  {
    ...
    costType: 'hp', cost: 40, cooldown: 18, range: 280, icon: '🐙', iconColor: '#4a044e',
  ...
  },
  {
    ...
    costType: 'hp', cost: 30, cooldown: 10, range: 240, icon: '🌊', iconColor: '#581c87',
  ...
  },
  {
    ...
    costType: 'hp', cost: 100, cooldown: 90, range: 300, icon: '💀', iconColor: '#881337',
  ...
  // Cultist Buffs
  {
    ...
    costType: 'hp', cost: 25, cooldown: 35, range: 0, icon: '📜', iconColor: '#b91c1c',
    descUk: 'Активація пакту темряви: тимчасово збільшує максимальне здоров\'я на 40% та силу темних заклять на 25% на 15 сек.',
    descEn: 'Activates a dark blood pact: temporarily grants +40% max HP and +25% dark spell power for 15s.'
  },
  {
  ...
  },
  {
    ...
    costType: 'hp', cost: 0, cooldown: 0, range: 240, icon: '🩸', iconColor: '#e11d48',
  ...
  },
  {
    ...
    costType: 'hp', cost: 50, cooldown: 15, range: 280, icon: '💉', iconColor: '#be123c',
  ...
  // Cultist Debuffs
  {
    ...
    costType: 'hp', cost: 20, cooldown: 15, range: 320, icon: '🥀', iconColor: '#a855f7',
  ...
  },
  {
    ...
    costType: 'hp', cost: 30, cooldown: 20, range: 320, icon: '⌛', iconColor: '#450a0a',
  ...
  },
  {
    ...
    costType: 'hp', cost: 25, cooldown: 12, range: 320, icon: '💔', iconColor: '#701a75',
  ...
  },
  {
    ...
    costType: 'hp', cost: 18, cooldown: 10, range: 280, icon: '🩸', iconColor: '#dc2626',
  ...
  },
  {
    ...
    costType: 'hp', cost: 25, cooldown: 14, range: 300, icon: '🐀', iconColor: '#14532d',
  ...
  },
  {
    ...
    costType: 'hp', cost: 20, cooldown: 16, range: 280, icon: '🧠', iconColor: '#581c87',
  ...
  },
  {
    ...
    costType: 'hp', cost: 18, cooldown: 12, range: 300, icon: '🌑', iconColor: '#1e293b',
  ...
  },
  {
    ...
    costType: 'hp', cost: 22, cooldown: 15, range: 320, icon: '⏳', iconColor: '#78716c',
  ...
  },
  {
    ...
    costType: 'hp', cost: 35, cooldown: 25, range: 200, icon: '😱', iconColor: '#4a044e',
  ...
  },
  {
    ...
    costType: 'hp', cost: 25, cooldown: 20, range: 320, icon: '🔥', iconColor: '#991b1b',
  ...
  // =========================================================================
  {
    ...
    costType: 'stamina', cost: 15, cooldown: 8, range: 70, icon: '🗡️', iconColor: '#f59e0b',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 6, range: 100, icon: '🤸', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 25, cooldown: 6, range: 120, icon: '🗡️', iconColor: '#e2e8f0',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 12, cooldown: 5, range: 70, icon: '🏹', iconColor: '#b45309',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 22, cooldown: 12, range: 280, icon: '👤', iconColor: '#6366f1',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 14, cooldown: 6, range: 80, icon: '🩼', iconColor: '#a1a1aa',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 25, cooldown: 15, range: 70, icon: '🩸', iconColor: '#991b1b',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 12, cooldown: 4, range: 200, icon: '🔄', iconColor: '#10b981',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 16, cooldown: 7, range: 90, icon: '⚔️', iconColor: '#f97316',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 5, range: 100, icon: '🗡️', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 15, cooldown: 4, range: 80, icon: '🧪', iconColor: '#16a34a',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 10, cooldown: 10, range: 90, icon: '⏳', iconColor: '#eab308',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 18, cooldown: 8, range: 100, icon: '↩️', iconColor: '#06b6d4',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 14, cooldown: 6, range: 70, icon: '👊', iconColor: '#71717a',
  ...
  // Archer Ranged & Magic Arrows
  {
    ...
    costType: 'stamina', cost: 25, cooldown: 4, range: 520, icon: '🎯', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 5, range: 480, icon: '⚡', iconColor: '#eab308',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 6, range: 440, icon: '💥', iconColor: '#dc2626',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 3, range: 460, icon: '❄️', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 22, cooldown: 5, range: 560, icon: '🏹', iconColor: '#cbd5e1',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 40, cooldown: 18, range: 440, icon: '🌧️', iconColor: '#94a3b8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 10, range: 400, icon: '🌑', iconColor: '#6366f1',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 18, cooldown: 2, range: 440, icon: '🐍', iconColor: '#16a34a',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 22, cooldown: 5, range: 440, icon: '🔄', iconColor: '#facc15',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 12, range: 480, icon: '🌪️', iconColor: '#0ea5e9',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 30, cooldown: 10, range: 600, icon: '💘', iconColor: '#e11d48',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 24, cooldown: 6, range: 240, icon: '💥', iconColor: '#ea580c',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 15, cooldown: 12, range: 480, icon: '🎯', iconColor: '#fbbf24',
  ...
  },
  {
    ...
    costType: 'mana', cost: 45, cooldown: 35, range: 500, icon: '⭐', iconColor: '#fef08a',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 12, range: 160, icon: '🪤', iconColor: '#78716c',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 25, cooldown: 15, range: 160, icon: '💣', iconColor: '#dc2626',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 16, range: 180, icon: '🛢️', iconColor: '#27272a',
  ...
  },
  {
    ...
    nameUk: 'Заклик попутного вітру', nameEn: 'Tailwind Burst',
    costType: 'stamina', cost: 15, cooldown: 25, range: 240, icon: '🍃', iconColor: '#4ade80',
    descUk: 'Закликає попутний вітер: дає лучнику та союзникам +25% швидкості бігу та +15% до ухилення на 10 сек.',
    descEn: 'Calls upon tailwinds: grants +25% move speed and +15% dodge chance to self and allies for 10s.'
  },
  {
  ...
  // Archer Debuffs
  {
    ...
    costType: 'stamina', cost: 15, cooldown: 10, range: 480, icon: '🎯', iconColor: '#ef4444',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 18, cooldown: 8, range: 440, icon: '🦿', iconColor: '#b45309',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 16, cooldown: 12, range: 400, icon: '🕶️', iconColor: '#facc15',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 10, range: 440, icon: '🛡️', iconColor: '#dc2626',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 18, cooldown: 14, range: 400, icon: '🧪', iconColor: '#84cc16',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 15, range: 280, icon: '🕸️', iconColor: '#71717a',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 15, cooldown: 6, range: 440, icon: '🔍', iconColor: '#ec4899',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 22, cooldown: 14, range: 400, icon: '💫', iconColor: '#eab308',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 18, cooldown: 12, range: 400, icon: '☣️', iconColor: '#15803d',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 20, cooldown: 20, range: 500, icon: '😱', iconColor: '#4c1d95',
  ...
  // Bear / Wolf / Hawk Melee
  {
    ...
    costType: 'mana', cost: 18, cooldown: 3, range: 90, icon: '🐻', iconColor: '#78350f',
  ...
  },
  {
    ...
    costType: 'mana', cost: 15, cooldown: 2, range: 80, icon: '🐺', iconColor: '#64748b',
  ...
  },
  {
    ...
    costType: 'mana', cost: 16, cooldown: 4, range: 200, icon: '🦅', iconColor: '#0284c7',
  ...
  },
  {
    ...
    costType: 'mana', cost: 24, cooldown: 6, range: 100, icon: '🐾', iconColor: '#92400e',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 5, range: 80, icon: '🐾', iconColor: '#475569',
  ...
  },
  {
    ...
    costType: 'mana', cost: 14, cooldown: 3, range: 90, icon: '🦅', iconColor: '#0ea5e9',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 10, range: 280, icon: '🐻', iconColor: '#b45309',
  ...
  },
  {
    ...
    costType: 'mana', cost: 18, cooldown: 8, range: 240, icon: '🐺', iconColor: '#334155',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 7, range: 90, icon: '🐻', iconColor: '#78350f',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 14, range: 80, icon: '🐺', iconColor: '#881337',
  ...
  },
  {
    ...
    costType: 'mana', cost: 15, cooldown: 4, range: 160, icon: '💨', iconColor: '#7dd3fc',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 14, range: 140, icon: '🐾', iconColor: '#92400e',
  ...
  },
  {
    ...
    costType: 'mana', cost: 14, cooldown: 3, range: 80, icon: '🐺', iconColor: '#dc2626',
  ...
  },
  {
    ...
    costType: 'mana', cost: 18, cooldown: 8, range: 180, icon: '🦅', iconColor: '#0284c7',
  ...
  },
  {
    ...
    costType: 'mana', cost: 10, cooldown: 2, range: 100, icon: '🌿', iconColor: '#15803d',
  ...
  },
  {
    ...
    costType: 'mana', cost: 28, cooldown: 16, range: 90, icon: '🐻', iconColor: '#ea580c',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 10, range: 90, icon: '🐺', iconColor: '#475569',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 6, range: 240, icon: '🪶', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 25, range: 120, icon: '🐻', iconColor: '#b45309',
  ...
  // Druid Nature Magic & Charms
  {
    ...
    costType: 'mana', cost: 18, cooldown: 1.5, range: 400, icon: '☀️', iconColor: '#facc15',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 2, range: 440, icon: '🌙', iconColor: '#818cf8',
  ...
  },
  {
    ...
    costType: 'mana', cost: 55, cooldown: 35, range: 480, icon: '⭐', iconColor: '#c084fc',
  ...
  },
  {
    ...
    costType: 'mana', cost: 45, cooldown: 40, range: 160, icon: '🐺', iconColor: '#64748b',
  ...
  },
  {
    ...
    costType: 'mana', cost: 50, cooldown: 50, range: 160, icon: '🌲', iconColor: '#15803d',
  ...
  },
  {
    ...
    costType: 'mana', cost: 32, cooldown: 8, range: 400, icon: '🌩️', iconColor: '#eab308',
  ...
  },
  {
    ...
    costType: 'mana', cost: 26, cooldown: 7, range: 300, icon: '🎋', iconColor: '#16a34a',
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 60, range: 240, icon: '🐾', iconColor: '#10b981',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 6, range: 240, icon: '🌿', iconColor: '#4ade80',
  ...
  },
  {
    ...
    costType: 'mana', cost: 60, cooldown: 90, range: 360, icon: '🌸', iconColor: '#f472b6',
  ...
  },
  {
    ...
    costType: 'mana', cost: 0, cooldown: 0, range: 240, icon: '🌵', iconColor: '#16a34a',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 10, range: 280, icon: '💚', iconColor: '#22c55e',
  ...
  // Druid Debuffs
  {
    ...
    costType: 'mana', cost: 25, cooldown: 12, range: 320, icon: '🌱', iconColor: '#15803d',
  ...
  },
  {
    ...
    costType: 'mana', cost: 30, cooldown: 25, range: 320, icon: '💤', iconColor: '#93c5fd',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 15, range: 200, icon: '🦁', iconColor: '#92400e',
  ...
  },
  {
    ...
    costType: 'mana', cost: 20, cooldown: 8, range: 320, icon: '🌿', iconColor: '#16a34a',
  ...
  },
  {
    ...
    costType: 'mana', cost: 24, cooldown: 10, range: 320, icon: '🐝', iconColor: '#ca8a04',
  ...
  },
  {
    ...
    costType: 'mana', cost: 22, cooldown: 12, range: 300, icon: '🪵', iconColor: '#451a03',
  ...
  },
  {
    ...
    costType: 'mana', cost: 35, cooldown: 20, range: 280, icon: '🍄', iconColor: '#a855f7',
  ...
  },
  {
    ...
    costType: 'mana', cost: 25, cooldown: 15, range: 320, icon: '🥀', iconColor: '#14532d',
  ...
  },
  {
    ...
    costType: 'mana', cost: 28, cooldown: 18, range: 280, icon: '💨', iconColor: '#84cc16',
  ...
  },
  {
    ...
    costType: 'mana', cost: 26, cooldown: 14, range: 280, icon: '🎋', iconColor: '#15803d',
...
export function resolveSkillVfx(skill) {
  if (!skill) return 'generic_slash';
  if (skill.vfx) return skill.vfx;
  const id = skill.id || '';
  const el = skill.element || (skill.class === 'Mage' ? 'fire' : (skill.class === 'Druid' ? 'lightning' : (skill.class === 'Cultist' ? 'shadow' : 'physical')));

  if (id.includes('beam') || id.includes('disintegrate') || id.includes('laser')) return 'arcane_beam';
  if (id.includes('wall_of_fire') || id.includes('fire_wall')) return 'fire_wall';
  if (id.includes('blast_wave') || id.includes('combustion')) return 'blast_wave';
  if (id.includes('mirror_image') || id.includes('clone')) return 'mirror_image';
  if (id.includes('temporal_warp') || id.includes('time_warp')) return 'temporal_warp';
  if (id.includes('prismatic')) return 'prismatic_burst';
  if (id.includes('polymorph')) return 'polymorph';
  if (id.includes('ball_lightning')) return 'ball_lightning';
  if (id.includes('gravity') || id.includes('singularity') || id.includes('black_hole')) return 'gravity_singularity';
  if (id.includes('blink') || id.includes('teleport') || id.includes('shadow_step')) return 'blink_flash';

  if (id.includes('barrage')) return 'barrage_shot';
  if (id.includes('rain_of_arrows') || id.includes('volley')) return 'rain_of_arrows';
  if (id.includes('poison_dart') || id.includes('venom')) return 'poison_dart';
  if (id.includes('caltrop')) return 'caltrops';
  if (id.includes('shuriken')) return 'shuriken';

  if (id.includes('scythe')) return 'scythe_sweep';
  if (id.includes('blood')) return 'blood_surge';
  if (id.includes('skull')) return 'skull_bolt';

  if (id.includes('holy_cross')) return 'holy_cross';
  if (id.includes('hammer')) return 'hammer_smash';
  if (id.includes('tornado') || id.includes('cyclone')) return 'tornado';
  if (id.includes('seed')) return 'nature_seed';

  if (id.includes('fireball') || id.includes('flame_orb') || id.includes('pyro')) return 'fireball_blast';
  if (id.includes('flame') || id.includes('fire') || id.includes('incinerat')) return 'flame_wave';
  if (id.includes('meteor') || id.includes('volcan')) return 'meteor_impact';
  if (id.includes('combust') || id.includes('blast') || id.includes('ignit')) return 'combustion';

  if (id.includes('chain_lightning') || id.includes('chain')) return 'chain_lightning';
  if (id.includes('lightning') || id.includes('storm_bolt') || id.includes('thunder_strike')) return 'lightning_strike';
  if (id.includes('thunder') || id.includes('static_nova')) return 'thunder_clap';
  if (id.includes('storm') || id.includes('tempest')) return 'storm_burst';

  if (id.includes('frost_nova') || id.includes('ice_ring') || id.includes('freeze')) return 'frost_nova';
  if (id.includes('ice_shard') || id.includes('frost_bolt') || id.includes('icicle')) return 'ice_shard';
  if (id.includes('blizzard') || id.includes('ice_storm')) return 'blizzard_blast';
  if (id.includes('glacial') || id.includes('frost_spike') || id.includes('piercing_cold')) return 'glacial_spike';

  if (id.includes('holy_pillar') || id.includes('pillar_of_light') || id.includes('sunbeam')) return 'holy_pillar';
  if (id.includes('smite') || id.includes('divine_blade') || id.includes('radiant_strike')) return 'divine_smite';
  if (id.includes('holy_nova') || id.includes('consecrat') || id.includes('blessing')) return 'holy_nova';
  if (id.includes('judgment') || id.includes('ray_of_light') || id.includes('radiant_beam')) return 'judgment_ray';

  if (id.includes('shadow_vortex') || id.includes('abyss')) return 'shadow_vortex';
  if (id.includes('void_bolt') || id.includes('shadow_bolt') || id.includes('dark_orb')) return 'void_bolt';
  if (id.includes('drain') || id.includes('siphon') || id.includes('life_tap')) return 'soul_drain';
  if (id.includes('curse') || id.includes('decay') || id.includes('agony') || id.includes('plague')) return 'curse_blast';

  if (id.includes('entangling') || id.includes('roots') || id.includes('nature') || id.includes('thorn')) return 'entangling_roots';
  if (id.includes('maul') || id.includes('swipe') || id.includes('bear')) return 'bear_maul';
  if (id.includes('bite') || id.includes('shred') || id.includes('wolf')) return 'wolf_bite';
  if (id.includes('talon') || id.includes('swoop') || id.includes('hawk')) return 'hawk_talon';

  if (id.includes('whirlwind') || id.includes('spin')) return 'whirlwind';
  if (id.includes('crush') || id.includes('slam') || id.includes('smash')) return 'crushing_blow';
  if (id.includes('shield')) return 'shield_slam';
  if (id.includes('cleave') || id.includes('sweep')) return 'cleave';
  if (id.includes('thrust') || id.includes('pierce') || id.includes('lunge')) return 'piercing_thrust';
  if (id.includes('stab') || id.includes('backstab') || id.includes('assassin') || id.includes('shadowstep')) return 'backstab';

  if (skill.type === 'magic' || skill.type === 'buff' || skill.type === 'debuff') {
    if (el === 'fire') return 'combustion';
    if (el === 'lightning') return 'lightning_strike';
    if (el === 'ice') return 'frost_nova';
    if (el === 'holy') return 'holy_pillar';
    if (el === 'shadow') return 'shadow_vortex';
    return 'spark_arcane';
  }
...
export function resolveSkillDamage(skill) {
  if (!skill) return { base: 12, hits: 1, text: '12 Damage' };
  if (skill.type === 'buff') {
    const desc = (skill.descEn || '') + ' ' + (skill.descUk || '');
    if (desc.includes('HP') || desc.includes('heal') || desc.includes('зцілює')) {
      return { base: 0, hits: 0, text: 'Heal +25% HP' };
    }
    if (desc.includes('mana') || desc.includes('мана')) {
      return { base: 0, hits: 0, text: 'Restores +35 MP' };
    }
    if (desc.includes('stamina') || desc.includes('витривал')) {
      return { base: 0, hits: 0, text: 'Restores +30 SP' };
    }
    return { base: 0, hits: 0, text: 'Buff / Utility' };
  }
  if (skill.type === 'debuff' && !skill.descEn?.includes('damage') && !skill.descUk?.includes('шкод')) {
    return { base: 0, hits: 0, text: 'Curse / Debuff' };
  }

  const id = skill.id || '';
  const desc = (skill.descEn || '') + ' ' + (skill.descUk || '');

  // Multi-projectile / Volley skills with individual arrow/projectile damage
  if (id === 'arc_barrage') {
    return { base: 5, hits: 12, text: '4-7 Phys (per arrow x12)' };
  }
  if (id === 'arc_fan_of_knives') {
    return { base: 6, hits: 8, text: '5-8 Phys (per dagger x8)' };
  }
  if (id === 'mag_magic_missiles') {
    return { base: 6, hits: 5, text: '5-8 Arcane (per dart x5)' };
  }
  if (id === 'mag_meteor_shower') {
    return { base: 14, hits: 4, text: '12-16 Fire (per meteor x4)' };
  }
  if (id === 'arc_rain_of_arrows' || id === 'arc_volley') {
    return { base: 5, hits: 14, text: '4-7 Phys (per arrow x14)' };
  }
  if (id.includes('multishot') || id.includes('triple')) {
    return { base: 8, hits: 3, text: '7-10 Phys (per arrow x3)' };
  }
  if (id === 'war_flurry_of_steel') {
    return { base: 7, hits: 4, text: '6-9 Phys (per hit x4)' };
  }
  if (id === 'war_twin_slash') {
    return { base: 8, hits: 2, text: '7-11 Phys (per hit x2)' };
  }
  ...
  if (pctMatch) {
    ...
    baseVal = Math.round(10 * (pct / 100) * 0.55);
  ...
  // Cap heavy nukes
  baseVal = Math.max(5, Math.min(28, baseVal));

  const minDmg = Math.max(3, Math.round(baseVal * 0.8));
  const maxDmg = Math.round(baseVal * 1.3);
  const elem = (skill.element || (skill.class === 'Archer' ? 'Phys' : (skill.class === 'Mage' ? 'Fire' : 'Magic'))).toUpperCase();

  return {
    base: baseVal,
    hits: 1,
    text: `${minDmg}-${maxDmg} ${elem}`
  };
}
