...
// F-007 (SOMET-187): village create and the creature re-roll now run inside a
// real transaction via pool.connect(), so this mock needs a connect() handing
// back a client that dispatches through the same handlers; BEGIN/COMMIT/
// ROLLBACK are answered directly instead of needing a handler in every test.
