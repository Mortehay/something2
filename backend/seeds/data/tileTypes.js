...
const DEFAULT_TILE_TYPES = [
  ...
  { name: 'highgrass', color: '#035c03ff', walkable: true, speed: 0.8, image: '', valid_neighbors: ['highgrass', 'grass', 'leafs', 'swamp'], prompt: floor('tall dense green grass') },
  ...
  { name: 'earth', color: '#8B4513', walkable: true, speed: 1, image: '', valid_neighbors: ['earth', 'grass', 'sand', 'rocks', 'dirt', 'swamp'], prompt: floor('bare brown earth soil') },
  ...
  { name: 'snow', color: '#FFFFFF', walkable: true, speed: 0.5, image: '', valid_neighbors: ['snow', 'rocks', 'ice'], prompt: floor('fresh white snow') },
  { name: 'ice', color: '#bae6fd', walkable: true, speed: 0.2, image: '', valid_neighbors: ['ice', 'snow', 'water'], prompt: floor('pale blue cracked ice') },
  { name: 'swamp', color: '#4d7c0f', walkable: true, speed: 0.1, image: '', valid_neighbors: ['swamp', 'earth', 'dirt', 'water', 'highgrass'], prompt: floor('murky green swamp mud') },
  ...
  { name: 'jungle_floor', color: '#1f6b2e', walkable: true, speed: 0.7, image: '', valid_neighbors: ['jungle_floor', 'highgrass', 'leafs', 'swamp'], prompt: floor('dense jungle undergrowth and vines') },
  { name: 'storm_shingle', color: '#6b7280', walkable: true, speed: 0.6, image: '', valid_neighbors: ['storm_shingle', 'sand', 'water', 'rocks'], prompt: floor('dark wet storm-beaten shore shingle') },
  ...
  { name: 'ash_waste', color: '#4a4038', walkable: true, speed: 0.7, image: '', valid_neighbors: ['ash_waste', 'ember_rock', 'rocks', 'dirt'], prompt: floor('grey volcanic ash drift') },
  ...
  { name: 'fungal_floor', color: '#6b7f3a', walkable: true, speed: 0.7, image: '', valid_neighbors: ['fungal_floor', 'swamp', 'dirt', 'blight_floor'], prompt: floor('spongy fungal mat floor') },
  ...
  { name: 'vault_floor', color: '#4f5560', walkable: true, speed: 1.0, image: '', valid_neighbors: ['vault_floor', 'cobblestone', 'foundry_floor', 'rocks'], prompt: floor('riveted iron vault plating') },
  { name: 'hive_floor', color: '#8a6a2f', walkable: true, speed: 0.8, image: '', valid_neighbors: ['hive_floor', 'dirt', 'cave_floor'], prompt: floor('waxy amber hive comb floor') },
  { name: 'cistern_shallows', color: '#3f5a63', walkable: true, speed: 0.4, image: '', valid_neighbors: ['cistern_shallows', 'water', 'cobblestone', 'swamp'], prompt: floor('shallow standing water over stone') },
  ...
  { name: 'blight_floor', color: '#5e6b3a', walkable: true, speed: 0.7, image: '', valid_neighbors: ['blight_floor', 'fungal_floor', 'swamp', 'dirt'], prompt: floor('sickly blighted crusted ground') },
  { name: 'foundry_floor', color: '#6a5a48', walkable: true, speed: 0.9, image: '', valid_neighbors: ['foundry_floor', 'vault_floor', 'ember_rock', 'rocks'], prompt: floor('soot-stained foundry stone') },

  // Abyssal
  { name: 'void_floor', color: '#1c1a24', walkable: true, speed: 0.9, image: '', valid_neighbors: ['void_floor', 'umbral_floor', 'chaos_floor'], prompt: floor('starless void-black surface') },
  { name: 'brimstone', color: '#8c3a1e', walkable: true, speed: 0.8, image: '', valid_neighbors: ['brimstone', 'ember_rock', 'ash_waste'], prompt: floor('sulphurous brimstone crust') },
  ...
  { name: 'sanctum_floor', color: '#b8a97a', walkable: true, speed: 1.0, image: '', valid_neighbors: ['sanctum_floor', 'cobblestone', 'ruin_stone'], prompt: floor('gilded fallen sanctum marble') },
  ...
  { name: 'plague_floor', color: '#6b6b33', walkable: true, speed: 0.7, image: '', valid_neighbors: ['plague_floor', 'blight_floor', 'fungal_floor'], prompt: floor('festering plague-slick ground') },
  ...
  { name: 'chasm', color: '#14121a', walkable: false, speed: 0, image: '', valid_neighbors: ['chasm', 'cave_floor', 'void_floor'], prompt: floor('a black bottomless chasm') },
  ...
  { name: 'road_ash', color: '#6e6257', walkable: true, speed: 1.15, image: '', valid_neighbors: [], prompt: floor('trodden grey volcanic cinders and ash') },
];
