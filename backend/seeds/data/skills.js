// backend/seeds/data/skills.js
// Catalog of 300 active/passive combat skills across the 6 playable classes.
// 50 skills per class: Melee, Magic, Buffs, Debuffs.
...
const SKILLS = [
  ...
  },
  {
    ...
    costType: 'mana', cost: 15, cooldown: 0, range: 500, icon: '🟣', iconColor: '#9333ea',
  ...
  // Monk Buffs
  {
    ...
    costType: 'mana', cost: 0, cooldown: 0, range: 240, icon: '🧘', iconColor: '#38bdf8',
  ...
  },
  {
    ...
    costType: 'stamina', cost: 0, cooldown: 0, range: 240, icon: '🍃', iconColor: '#4ade80',
...
function isWeaponCompatible(reqWeapon, weaponCategory) {
...
function getWeaponRequirementName(reqWeapon) {
...
function checkGemRequirements(gem, playerProgression, equippedWeapon) {
...
function resolveSkillVfx(skill) {
  ...
  if (id.includes('shadow_vortex') || id.includes('black_hole') || id.includes('abyss')) return 'shadow_vortex';
  ...
  if (id.includes('whirlwind') || id.includes('cyclone') || id.includes('spin')) return 'whirlwind';
  if (id.includes('crush') || id.includes('slam') || id.includes('smash') || id.includes('hammer')) return 'crushing_blow';
